  ...
  return (<>
    <div className='hidden h-16 w-full bg-indigo-300 md:flex justify-between items-center'>
      ...
      <div className=' hidden md:block md:mr-8'>
        <Link className='p-4 text-xl hover:text-indigo-100' href={'/'}>Home</Link>
        <Link className='p-4 text-xl hover:text-indigo-100' href={'/profile'}>Profile</Link>
        <LogoutBtn />
        <Link className='p-4 text-xl hover:text-indigo-100' href={'/signup'}>Signup</Link>
      </div>
    </div>
    <div onClick={handleClick} id='navBar' className=' md:hidden h-16 w-full bg-indigo-300 flex justify-between items-center'>
